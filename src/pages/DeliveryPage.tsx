      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-3xl mx-auto bg-secondary/10 p-6 rounded-lg border border-secondary mb-12">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-bold">Спеціальна пропозиція!</h2>
          </div>
          <p className="text-lg">
            У зв'язку з відкриттям нашого закладу, доставка абсолютно <strong>БЕЗКОШТОВНА</strong> на будь-яке замовлення в межах міста Київ!
            Скористайтеся цією можливістю, поки акція діє.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold mb-2">Безкоштовна доставка</h3>
            <p className="text-gray-600">
              На будь-яке замовлення в межах міста Київ доставка безкоштовна. 
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-12">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start">
              <span className="inline-block w-2 h-2 bg-primary rounded-full mt-2 mr-2"></span>
              <span>Мінімальна сума замовлення відсутня на період акції</span>
            </li>
            <li className="flex items-start">
              <span className="inline-block w-2 h-2 bg-primary rounded-full mt-2 mr-2"></span>
